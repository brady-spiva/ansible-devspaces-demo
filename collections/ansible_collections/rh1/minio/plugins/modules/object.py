...
def fget_object(client, bucket_name, object, dest):
    ...
    # remove bucket
    raise NotImplementedError("fget_object not implemented")

def remove_object(client, bucket_name, object):
    # remove object
    raise NotImplementedError("remove_object not implemented")

# EXTRA
def list_object(module, client, bucket_name):
    # TODO
    raise NotImplementedError("list_object not implemented")

def copy_object(module, client, bucket_name, object, src_bucket_name, src_object):
    # TODO 
    raise NotImplementedError("copy_object not implemented")

def run_module():
    
    # TODO_1: Define all of the parameters needed to run the object module, bucket_name is provided for you. 
    # HINT: you will need to add 6 more parameters to the module_args dictionary.
